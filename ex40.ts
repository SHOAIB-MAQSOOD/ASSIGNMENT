...
let makeAlbum = (artist: string, title: string, tracks?: number): Album=> {
  ...
  const album1: Album = makeAlbum("singer1", "song1");
  const album2: Album = makeAlbum("singer2", "song2");
  const album3: Album = makeAlbum("singer3", "song3", 10);
