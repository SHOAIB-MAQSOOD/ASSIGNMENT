...
var personName1 = "shoaib maqsood";
console.log("Name : ".concat(personName1));
console.log("Name in lower case : ".concat(personName1.toLowerCase()));
console.log("Name in Upper case : ".concat(personName1.toUpperCase()));
var titleCaseName1 = personName1.split(" ");
for (var i = 0; i < titleCaseName1.length; i++) {
    titleCaseName1[i] =
